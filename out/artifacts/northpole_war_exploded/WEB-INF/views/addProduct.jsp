    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category"
                                                             value="super" />Super</label>
            <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category"
                                                             value="cone" />Cones</label>
            <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category"
                                                             value="novelty" />Bar/Novelty</label>
        </div>
        ...
        <div class="form-group">
            <label for="price">Sale Price</label>  <form:errors path="recSalePrice" cssStyle="color: #ff0000;" />
            <form:input path="recSalePrice" id="price" class="form-Control"/>
        </div>
